...
//echo $ans;
$send = curl_init();
curl_setopt($send, CURLOPT_URL, "https://web.njit.edu/~ap2257/BackEnd/backend_logic.php");
...
for($i = 0; $i < $count; $i++){
  ...
  $send1 = curl_init();
  curl_setopt($send1, CURLOPT_URL, "https://web.njit.edu/~ap2257/BackEnd/backend_logic.php");
 ...
 $case_input = $obj1->{'parameter'};//testcaseinput
  ...
  $constraint = $obj1->{'constraints'};
   ...
   if($struct == 'gradeExam'){
    ...
    $send2 = curl_init();
    curl_setopt($send2, CURLOPT_URL, "https://web.njit.edu/~ap2257/BackEnd/backend_logic.php");
